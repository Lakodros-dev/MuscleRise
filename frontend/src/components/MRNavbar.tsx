...
const MRNavbar = memo(function MRNavbar() {
  ...
  if (!state) {
    return (
      <header className="sticky top-0 z-30 w-full border-b backdrop-blur bg-black/50 border-white/10">
        ...
        <nav className="flex items-center gap-2 md:gap-4 text-sm">
          ...
          <div className="ml-2 flex items-center gap-3">
            <div className={cn(
              ...
              <span className={isWhiteTheme ? "text-white/90" : "opacity-70"}>{t.common.coins}</span>
